  ...
  const handleAddEmployee = async () => {
    ...
    try {
      ...
      // Add optional fields if selected
       ...
       employeeData.positionId = newEmployee.positionId
      employeeData.shiftId = newEmployee.shiftId
       employeeData.deviceId = newEmployee.deviceId
  ...
  const saveEditEmployee = async () => {
    ...
    try {
      ...
      // Add optional fields if selected (but NOT deviceId)
       updateData.departmentId = (editValue.departmentId === "none" ? null : editValue.departmentId)
       updateData.positionId = editValue.positionId === "none" ? null : editValue.positionId
      updateData.shiftId = editValue.shiftId === "none" ? null : editValue.shiftId
